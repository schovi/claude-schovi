...
def main():
    ...
    results = [
        ...
        case("ready with open questions fails", ready("010-a.md", READY_OK + "\n## Open questions\n- which cache?\n"), 1),
        case("draft with open questions passes", lambda wf: task(wf, "draft", "010-a.md", "# 010 — A\n\n## Open questions\n- which cache?\n"), 0),
        case("empty open questions section in ready passes", ready("010-a.md", READY_OK + "\n## Open questions\n"), 0),
